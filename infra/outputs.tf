...
output "registry_url" {
  ...
  value       = "${var.region}-docker.pkg.dev/${var.project_id}/myra-language-teacher/dino-app"
}
...
output "docker_push_command" {
  ...
  value       = <<-EOT
    ...
    docker build -t ${var.region}-docker.pkg.dev/${var.project_id}/myra-language-teacher/dino-app:latest .
